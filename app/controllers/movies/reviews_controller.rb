module Reviews
  ...
  class Movies::ReviewsController < MoviesController
    ...
    def create
      ...
      respond_to do |format|
        if @review.save
          ...
          format.json { render :show, status: :created, location: review_path }
        else
    ...
    def update
      respond_to do |format|
        if @review.update(review_params)
          ...
          format.json { render :show, status: :ok, location: review_path }
        else
    ...
    def destroy
      @review.destroy
      respond_to do |format|
        format.html { redirect_to :back, notice: 'Review was successfully deleted.' }
